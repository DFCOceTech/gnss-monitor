...
The system SHALL write every sample to SQLite tables: gnss_samples, satellite_metrics, rf_metrics.
...
### What's Built
- `src/gnss_monitor/collector.py` — GNSSCollector, polling mode via raw UBX frames, UBXReader over BytesIO
- `src/gnss_monitor/storage.py` — SQLite insert methods
